...
function TeamComponent({ image, names, fb, tw, ig }) {
  return (
    <div className='border-2 border-gray-300 rounded-xl w-full max-w-[270px] flex flex-col items-center hover:bg-gradient-to-r from-linearx via-lineary to-linearz transition-colors'>
      <div className='p-4 flex flex-col gap-6 w-full'>
        <div className='w-full'>
          <img src={image} alt="image" className='w-full h-40 object-cover rounded-t-xl' />
        </div>
